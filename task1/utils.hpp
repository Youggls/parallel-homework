...
float** matmul(float** a, float** b, vector<size_t> shapeA, vector<size_t> shapeB, bool simd=false);
...
float** linearLayer(float** input, float** weight, float* bias, size_t batchSize, size_t inputSize, size_t outputSize, bool simd=false);
